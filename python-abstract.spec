%define name python-abstract
%define version 2021.11.29.1
%define unmangled_version 2021.11.29.1
%define release 1
...
Version: %{version}
Release: %{release}
Source0: https://files.pythonhosted.org/packages/8a/f6/42b1a2663e79bafbd4d9ded7f55fd7def4dc82675f8cbbe28719d504ce0a/abstract-2021.11.29.1.tar.gz
License: MIT
Group: Development/Libraries
BuildRoot: %{_tmppath}/%{name}-%{version}-%{release}-buildroot
Prefix: %{_prefix}
BuildArch: noarch
Vendor: Idin <py@idin.ca>
