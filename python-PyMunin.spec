...
%define unmangled_version 0.9.27
%define release 1
...
Version: %{version}
Release: %{release}
Source0: https://github.com/aouyar/PyMunin/tarball/master
License: GPL
Group: Development/Libraries
BuildRoot: %{_tmppath}/%{name}-%{version}-%{release}-buildroot
Prefix: %{_prefix}
BuildArch: noarch
Vendor: Ali Onur Uyar <aouyar at gmail.com>
Packager: Robert Santos <robert.santoshld2018@gmail.com> and Ali Dia <ali_dia@student.uml.edu>
...
cd ~/rpmbuild/SOURCES/
tar -xzvf master
mv  aouyar-PyMunin-94624d4 %{name}-%{version}
rm master
...
%changelog
Thu Feb 10 2022 Robert Santos <robert.santoshld2018@gmail.com> and Ali Dia <ali_dia@student.uml.edu>
* - First PyMunin package
